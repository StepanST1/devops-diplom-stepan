...
* [Описание проекта:](#описание-проекта)
  ...
  * [Решение:](#решение)
     * [1. Подготовка облачной инфраструктуры](#1-подготовка-облачной-инфраструктуры)
     * [2. Установка Docker на виртуальной машине](#2-установка-docker-на-виртуальной-машине)
     * [3. Подготовка тестового приложения](#3-подготовка-тестового-приложения)
     * [4. Публикация образа в реестре](#4-публикация-образа-в-реестре)
     * [5. Настройка CI/CD](#5-настройка-cicd)
     * [6. Документация и финальная проверка](#6-документация-и-финальная-проверка)
